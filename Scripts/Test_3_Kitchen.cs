...
public enum Test_3FStates {
	PREPARATION,
	SIMULATION,
	EVALUATION
}

public class Test_3_Kitchen : MonoBehaviour {
	...
	LargeObject buildKitchen() {
		...
		cooker.position = new Vector3(-0.0315f, -0.211f, 0.3166f);
		...
		// Positioned determined by hand
		whiteleft.position = new Vector3(-0.06f, -0.211f, 1.896f);
		...
		// Positioned determined by hand
		drawerleft.position = new Vector3(0.196f, -0.211f, 1.337f);
		...
		// Positioned determined by hand
		drawerright.position = new Vector3(-0.055f, -0.211f, 0.829f);
		...
		// Positioned determined by hand
		washer.position = new Vector3(0.0f, -0.211f, -0.847f);
		...
		// Positioned determined by hand
		rightmost_l.position = new Vector3(0.0f, -0.211f, -1.289f);
		...
		// Positioned determined by hand
		rightmost_r.position = new Vector3(0.23f, -0.211f, -1.846f);
	...
	void Awake() {
		if (!StaticValues.initialized) {
			...
			StaticValues.sw = new StreamWriter(Application.dataPath + "/../Logs/Test_3_Kitchen/Test_3_Kitchen_" + StaticValues.timestamp + ".json");
	...
	void Quit() {
		...
		if (StaticValues.runCount == runs-1) {
			...
			resUpdated = false;
			SceneManager.LoadScene("Test_3_Kitchen");
		}
	}
	...
	void OnApplicationQuit() {
		...
		//System.Diagnostics.Process.Start(Application.dataPath + "/../Logs/Test_3_Kitchen/Test_3_Kitchen_" + StaticValues.timestamp + ".json");
	}
}